...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransaction = new EntityInsertionAdapter<Transaction>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `transactions` (`id`,`type`,`amount`,`category`,`description`,`date`,`icon`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTransaction = new EntityDeletionOrUpdateAdapter<Transaction>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `transactions` SET `id` = ?,`type` = ?,`amount` = ?,`category` = ?,`description` = ?,`date` = ?,`icon` = ? WHERE `id` = ?";
      }
      ...
      public List<Transaction> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Transaction(_tmpId,_tmpType,_tmpAmount,_tmpCategory,_tmpDescription,_tmpDate,_tmpIcon);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<Transaction>> getTransactionsByType(final String type) {
  ...
  @Override
  public Flow<List<Transaction>> getTransactionsByDateRange(final Date startDate,
      final Date endDate) {
