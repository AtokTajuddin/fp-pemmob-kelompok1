...
import 'profile_page.dart'; // <--- 1. Add Import
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  List<Widget> get _pages {
    return [
      ...
      const AiChatPage(),
      ProfilePage(username: widget.username), // <--- 3. Replace Placeholder
    ];
  }
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                              "You spent 20% less on food this week! Ask Fundo for details?",
                              style: TextStyle(
                                fontSize: 13,
                                color: Colors.black87,
                              ),
